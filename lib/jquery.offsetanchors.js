...
jQuery.fn.offsetAnchors = function () {
    ...
    var currentTargetName, isClick, offsetScroll, $offsetElem = this;

    offsetScroll = function() {
        var targetElemName, targetScroll,  targetElemOffset, offsetElemHeight, offsetElemY, targetElem;
    ...
    jQuery.fn.offsetAnchors = function () {
        throw "@method jQuery.fn.offsetAnchors: Anchors can only be offset from a single element. Current offset elem is: " + $offsetElem.selector;
    };
};